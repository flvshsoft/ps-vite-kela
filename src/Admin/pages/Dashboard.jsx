import { FaShoppingCart, FaTruck, FaBan, FaDollarSign,FaShoppingBag } from "react-icons/fa";
...
export default function Dashboard() {
  return (
    ...
    {/* CARD COUNT */}
    <div id="dashboard-grid" className="p-5 grid sm:grid-cols-1 md:grid-cols-3 gap-4">
        {/* Shipped Orders */}
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 px-5 pb-5">
        ...
        <div className="bg-[#FFF1D5] rounded-xl p-5 shadow-md">
          <Chart 
            ...
            series={[{ name: 'Data', data: [80, 40, 60, 20, 45, 30, 80, 90, 85, 90, 30] }]}
            type="bar"
            height={300}
          />
        </div>
